          ...
          <div :class="cellClasses(column)">
            ...
            <template v-else>
              ...
              <Poptip
                ...
                v-model:value="getColumn(rowIndex, index)._filterVisible"
                placement="bottom"
              ...
              >
                ...
                <template v-if="getColumn(rowIndex, index)._filterMultiple" v-slot:content>
                  <div
                  ...
                  >
                    <div :class="[prefixCls + '-filter-list-item']">
                      <checkbox-group
                        v-model:value="
                          getColumn(rowIndex, index)._filterChecked
                        "
                      >
                        <checkbox
